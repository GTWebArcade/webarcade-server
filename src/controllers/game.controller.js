...
exports.createGame = async (req, res) => {
  const game = new Game({
    ...
    unityDataUrl: req?.body?.unityDataUrl,
    unityLoaderUrl: req?.body?.unityLoaderUrl,
    unityFrameworkUrl: req?.body?.unityFrameworkUrl,
    unityCodeUrl: req?.body?.unityCodeUrl,
